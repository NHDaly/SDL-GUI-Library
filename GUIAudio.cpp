...
GUIMusic::GUIMusic(string filename)
{
...
GUISound_clip::GUISound_clip(string filename)
{
...
GUISound_clip::~GUISound_clip(){
	
	if (sound_clip_impl)
		Mix_FreeChunk(sound_clip_impl);
}

void GUISound_clip::play(int vol, int delay, int pan, int pitch){
